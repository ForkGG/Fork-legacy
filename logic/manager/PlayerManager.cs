...
namespace Fork.Logic.Manager
{
    public sealed class PlayerManager
    {
        ...
        public async Task<Player> GetPlayer(string name)
        {
            ...
            if (existingPlayers.Any()) return existingPlayers.First();
        ...
        {
            {
                ...
                foreach (World world in viewModel.Worlds)
                    ...
                    {
                        DirectoryInfo playerData =
                            new DirectoryInfo(Path.Combine(world.Directory.FullName, "playerdata"));
                        if (playerData.Exists)
                                ...
                                SearchOption.TopDirectoryOnly))
                            {
                                ...
                                if (ValidateUuid(uuid)) playerIDsToAdd.Add(uuid);
                            }
                    }
                ...
                foreach (string uuid in playerIDsToAdd)
                {
                    ...
                    lock (Instance)
                    {
                        if (!playerGenerators.ContainsKey(uuid)) playerGenerators.Add(uuid, GetPlayerFromUuid(uuid));
                    }
        ...
        private async Task<Player> GetPlayerFromUuid(string uuid)
        {
            ...
            else
            {
                ...
                if (playerDir.Exists) playerDir.Delete(true);
            }
        ...
        private HashSet<Player> InitializePlayerSet()
        {
            ...
            if (!File.Exists(PlayerJsonPath)) return new HashSet<Player>();
        ...
        private PlayerManager()
        {
            ...
            Task.Run(async () =>
            {
                ...
                foreach (var player in PlayerSet.Where(player =>
                ...
                if (anyUpdate) SafePlayersToFile();
            });
        }
