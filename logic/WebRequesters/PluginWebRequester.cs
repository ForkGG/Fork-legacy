...
namespace Fork.Logic.WebRequesters
{
    public class PluginWebRequester
    {
        ...
        public List<Plugin> RequestResourceList(out bool fullyLoaded, string searchQuery,
            PluginCategory category = null, int page = 1, PluginEnums.Sorting sort = PluginEnums.Sorting.RATING)
        {
        ...
        private string BuildResourceURL(int pageSize, int page = 1,
            PluginEnums.Sorting sort = PluginEnums.Sorting.RATING)
        {
